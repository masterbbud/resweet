...
class GroupPageState extends State<GroupPage> {
  ...
  TextEditingController codeGenController = TextEditingController(text: '');
                          ...
                          children: [
                            ...
                            SizedBox(
                              ...
                              Padding(
                                ...
                                child: Row(children: [
                                  Spacer(),
                                  Text('or use a one-time invite code:'),
                                  Spacer(),
                                ],),
                              ),
                              Row(children: [
                        ...
                        child: Column(
                          children: [
                            Container(
                                ...
                                padding:
                                    const EdgeInsets.fromLTRB(0, 30, 0, 30),
                                child: Text("Join from Invite Code",
                                    style: TextStyle(
                                        fontSize: 44,
                                        color: Theme.of(context)
                                            .colorScheme
                            ...
                            SizedBox(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    TextButton(
                                      onPressed: () {
                                        api.joinWithCode(codeController.text);
                                        Navigator.pop(context);
                                      },
                                      child: Text("Join",
                                          style: TextStyle(
